...
Поэтому был придуман способ кодирования данных, при котором ограничивается количество следующих друг за другом бит одного типа. Самые распространенные методы кодирования информации на дискетах и ранних жестких дисках это FM, MFM, GCR. Хорошая [статья][1] на эту тему от инженеров компании Shugart Associates, создавшей первые дисководы на ГМД. В формате 840Кб используется именно MFM для хранения данных.
