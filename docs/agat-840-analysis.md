...
Потратив немного времени на анализ содержимого файла в текстовом редакторе, я вычислил, что реальный desync для формата АГАТ 840Кб представляет собой «10**0**0100100100100» или «0x12» в шестнадцатеричном виде. Следом за ним следует обязательный байт 0xFF, недоступный для ОС. 
